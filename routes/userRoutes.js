...
router.route('/signupAdmin').post(authController.signupAdmin);
router.route('/signupCustomer').post(authController.signupCustomer);
router.route('/signupVendor').post(authController.signupVendor);
